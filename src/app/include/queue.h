...
// queue.h
#ifndef MICROBIT_BAREMETAL_QUEUE_H
#define MICROBIT_BAREMETAL_QUEUE_H
#include "message.h"
#include <stddef.h>
...
private:
  Message *m_buf;
  size_t m_capacity;
  size_t m_read;  // read index into the m_buf . We move index forward AFTER the
                  // read
  size_t m_write; // write index into the m_buf . We move index forward AFTER
                  // the write
...
#endif // MICROBIT_BAREMETAL_QUEUE_H
